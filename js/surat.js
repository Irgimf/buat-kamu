$(document).ready(function () {
  ...
  $("#giftBox")
    ...
    .on("click", function () {
      ...
      let message =
        "Selamaatt Ulang Tahun Aisaa!! sedikit pesan untuk orang yang lahirnya samaan tanggal 24 wkwk.. wish u got anything u want, sehat selalu, wish u the best pokoknya.. Makasih buat keseruannya selama ini, even we are stranger in rl, jauh beribu km, beda pulau, beda kepercayaankah?, tetapi entah kenapa tiap main ama kamu tuh terasa deket banget like our strike in GAG yang tb tb gede itu wkwkwk.. senang bisa mendengar suara aisa, ketawanya aisa, bercandanya aisa seakan akan mendengar something special yang telah ditakdirkan untuk membuat alam tersenyum tertawa senang dengan kehadiran aisa aisa ini.. and yup i hope we still contact each other even nanti kita pasti punya kesibukan tersendiri.. semangattt untuk berprosesnya yaa cmartt girl... buat hadiahnya ku kasih sebuah quest aja ya wkwkwk, kerjain questnya nanti dapet hadiah spesial pake banget.. dan Selamat Kamu mendapatkan sebuah quest spesial 🎉";
